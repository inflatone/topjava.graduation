...
public class RestRepositoryErrorHandler {
    ...
    public static final Map.Entry<String, String> EXCEPTION_DUPLICATE_DAILY_MENU = Map.entry("restaurant", "Restaurant has already provided today's menu");
    ...
    private static final Map<String, Map.Entry<String, String>> CONSTRAINS_I18N_MAP = Map.of(
            ...
            DailyMenu.UNIQUE_RESTAURANT_DATE_INDEX, EXCEPTION_DUPLICATE_DAILY_MENU
    );
